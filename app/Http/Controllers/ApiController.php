            ...
            if($headerData['key'][0] == env('PROJECT_KEY')){
                ...
                if($getTokenValue['status']){
                    ...
                    if($getUser){
                        ...
                        $getContent1 = Page::select('long_description', 'short_description')->where('id', '=', 3)->first();
                        $getContent2 = Page::select('long_description', 'short_description')->where('id', '=', 5)->first();
