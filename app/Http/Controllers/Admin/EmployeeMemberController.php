...
class EmployeeMemberController extends Controller
{
    ...
    {        
        $this->data = array(
            'title'             => 'Admin & Employee Member',
            'controller'        => 'EmployeeMemberController',
            'controller_route'  => 'employee-member',
            'primary_key'       => 'id',
        );
    }
    /* list */
        public function list(){
            ...
            $page_name                      = 'employee-member.list';
            $data['rows']                   = User::where('status', '!=', 3)->where('type', '=', 2)->orderBy('id', 'DESC')->get();
    ...
    /* add */
        public function add(Request $request){
            ...
            $page_name                      = 'employee-member.add-edit';
            $data['row']                    = [];
            echo $this->admin_after_login_layout($title,$page_name,$data);
        }
    /* add */
