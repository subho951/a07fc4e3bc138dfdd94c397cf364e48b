...
class MemberController extends Controller
{
        ...
        public function add(Request $request){
            ...
            if($request->isMethod('post')){
                ...
                User::create([
                    ...
                    'industry_id'                   => ((array_key_exists("industry_id",$postData))?(($request->industry_id != '')?json_encode($request->industry_id):[]):[]),
    ...
    /* member points */
        public function points_history(Request $request, $id){
            ...
            $data['rows']                   = UserPoint::select('user_points.*', 'events.title')
                                                        ->join('events', 'events.id', '=', 'user_points.event_id')
                                                        ->where('user_points.member_id', '=', $id)
