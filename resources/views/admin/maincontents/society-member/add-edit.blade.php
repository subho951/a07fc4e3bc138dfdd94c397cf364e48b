      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              <label for="short_profile" class="col-md-2 col-lg-2 col-form-label">Short Profile <span class="text-danger">*</span></label>
              <div class="col-md-10 col-lg-10">
                <textarea name="short_profile" class="form-control" id="short_profile" rows="3" required><?=$short_profile?></textarea>
