            ...
            <tbody>
              <?php if($rows){ $sl=1; foreach($rows as $row){?>
                <tr>
                  ...
                  <td>
                    <?php if($row->photo != ''){?>
                      <img src="<?=env('UPLOADS_URL').'user/'.$row->photo?>" class="img-thumbnail" alt="<?=$row->name?>" style="width: 50px; height: 50px; margin-top: 10px;">
                    <?php } else {?>
                      <img src="<?=env('NO_IMAGE')?>" alt="<?=$row->name?>" class="img-thumbnail" style="width: 50px; height: 50px; margin-top: 10px;">
                    <?php }?>
                  </td>
                  <td><?=$row->points?></td>
                  <td>
